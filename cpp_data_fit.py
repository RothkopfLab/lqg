...
def parse_args(args=None, namespace=None):
    ...
    parser.add_argument(
        "--nburnin", type=int, default=1_500, help="Number of burn-in samples."
    )
    parser.add_argument("--nchain", type=int, default=4)
    parser.add_argument("--model", type=str, default="BoundedActor", help="Model type")
    parser.add_argument("--seed", type=int, default=1, help="Random seed (for NUTS)")
    parser.add_argument(
        "--shared_params",
        type=str,
        nargs="*",
...
if __name__ == "__main__":
    ...
    data, bws = load_tracking_data(
        delay=args.delay, clip=args.clip, subtract_mean=False
    )
